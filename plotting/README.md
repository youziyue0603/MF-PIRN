...
- `data/mesh_convergence.csv` and `data/energy_performance_cases.csv`: mechanics-hierarchy results.
- `data/candidate_14D_designs.csv`: design-variable sensitivity records.
- `data/material_curves.csv` and `data/cycle_retention.csv`:
...
- `scripts/plot_all.py`: reads the fixed data and exports Figures 3-8 and supplementary Figures 11-12.
